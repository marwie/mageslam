...
namespace
{
    void SetDefaultSettings(mage::MageSlamSettings& settings)
    {
        ...
        //     "FastUVAtlasSettings": {
        //       "NumKeyFrames": 14,
        //       "NumTextureSelectionFrames": 14,
        //       "MinDepthRangeScaleFactor": 1,
        //       "SmoothingWindowSize": 16,
        //       "DilatePixelCountTexture": 8
        //     }
        //   }
        // }*/
    }
    ...
    struct Session
    {
        Session(std::unique_ptr<mage::MAGESlam> slam, std::shared_ptr<const mage::calibration::Poly3KCameraModel> cameraModel)
            : Slam{ std::move(slam) }
        ...
        std::unique_ptr<mage::MAGESlam> Slam{};
