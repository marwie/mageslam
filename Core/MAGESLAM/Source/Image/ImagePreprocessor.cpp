...
namespace mage
{
                                                          ...
                                                          cv::Mat& preparedImage, CameraCalibration& preparedCameraCalibration, float& scaleSourceToTarget)
    {
        ...
        {
            //TODO: recommended decimation is INTER_AREA, didn't change behavior from STEREO_DEMO Deliverable 14147278
        ...
        {
            preparedImage = rawSourceImage.clone(); //TODO: detect if src Mat & is same as dst mat &, skip the copy if it is in-place TASK 14292406
