...
EXTERN_C __declspec(selectany) const WCHAR CvMarkersManifestTemplate[] = 
L"<instrumentationManifest\r\n"
L"    xmlns=\"http://schemas.microsoft.com/win/2004/08/events\"\r\n"
L"    xmlns:win=\"http://manifests.microsoft.com/win/2004/08/windows/events\"\r\n"
L"    xmlns:xs=\"http://www.w3.org/2001/XMLSchema\">\r\n"
L"  <instrumentation>\r\n"
L"    <events>\r\n"
L"      <provider\r\n"
L"        name=\"ConcurrencyVisualizerMarkers\"\r\n"
L"        guid=\"%s\"\r\n"
L"        messageFileName=\"\"\r\n"
L"        resourceFileName=\"\"\r\n"
L"        symbol=\"ConcurrencyVisualizerMarkers\">\r\n"
L"        <tasks>\r\n"
L"          <task name=\"Span\" value=\"1\" />\r\n"
L"          <task name=\"Flag\" value=\"2\" />\r\n"
L"          <task name=\"Message\" value=\"3\" />\r\n"
L"        </tasks>\r\n"
L"        <opcodes>\r\n"
L"          <opcode name=\"WriteFlag\" message=\"$(string.opcode_WriteFlag)\" value=\"11\" />\r\n"
L"          <opcode name=\"WriteMessage\" message=\"$(string.opcode_WriteMessage)\" value=\"12\" />\r\n"
L"        </opcodes>\r\n"
L"        <events>\r\n"
L"          <event symbol=\"EnterSpan\" value=\"1\" version=\"1\" level=\"win:Informational\" task=\"Span\" opcode=\"win:Start\" template=\"EnterSpanArgs\" />\r\n"
L"          <event symbol=\"LeaveSpan\" value=\"2\" version=\"1\" level=\"win:Informational\" task=\"Span\" opcode=\"win:Stop\" template=\"LeaveSpanArgs\" />\r\n"
L"          <event symbol=\"WriteFlag\" value=\"3\" version=\"1\" level=\"win:Informational\" task=\"Flag\" opcode=\"WriteFlag\" template=\"WriteFlagArgs\" />\r\n"
L"          <event symbol=\"WriteMessage\" value=\"4\" version=\"1\" level=\"win:Informational\" task=\"Message\" opcode=\"WriteMessage\" template=\"WriteMessageArgs\" />\r\n"
L"        </events>\r\n"
L"        <templates>\r\n"
L"          <template tid=\"EnterSpanArgs\">\r\n"
L"            <data name=\"cvType\" inType=\"win:UInt8\" />\r\n"
L"            <data name=\"cvImportance\" inType=\"win:UInt8\" />\r\n"
L"            <data name=\"cvCategory\" inType=\"win:UInt8\" />\r\n"
L"            <data name=\"cvSpanId\" inType=\"win:Int32\" />\r\n"
L"            <data name=\"cvSeries\" inType=\"win:UnicodeString\" />\r\n"
L"            <data name=\"cvTextW\" inType=\"win:UnicodeString\" />\r\n"
L"            <data name=\"cvTextA\" inType=\"win:AnsiString\" />\r\n"
L"          </template>\r\n"
L"          <template tid=\"LeaveSpanArgs\">\r\n"
L"            <data name=\"cvType\" inType=\"win:UInt8\" />\r\n"
L"            <data name=\"cvImportance\" inType=\"win:UInt8\" />\r\n"
L"            <data name=\"cvCategory\" inType=\"win:UInt8\" />\r\n"
L"            <data name=\"cvSpanId\" inType=\"win:Int32\" />\r\n"
...
L"            <data name=\"cvTextA\" inType=\"win:AnsiString\" />\r\n"
L"          </template>\r\n"
L"          <template tid=\"WriteMessageArgs\">\r\n"
L"            <data name=\"cvType\" inType=\"win:UInt8\" />\r\n"
L"            <data name=\"cvImportance\" inType=\"win:UInt8\" />\r\n"
L"            <data name=\"cvCategory\" inType=\"win:UInt8\" />\r\n"
L"            <data name=\"cvSeries\" inType=\"win:UnicodeString\" />\r\n"
...
L"  </instrumentation>\r\n"
L"  <localization>\r\n"
L"    <resources culture=\"en-US\">\r\n"
L"      <stringTable>\r\n"
L"        <string id=\"opcode_WriteFlag\" value=\"WriteFlag\"/>\r\n"
L"        <string id=\"opcode_WriteMessage\" value=\"WriteMessage\"/>\r\n"
L"      </stringTable>\r\n"
L"    </resources>\r\n"
L"  </localization>\r\n"
L"</instrumentationManifest> ";
...
__inline _Check_return_ HRESULT CvInitProvider(_In_ const GUID* pGuid, _Out_ PCV_PROVIDER* ppProvider)
{
    ...
    *ppProvider = NULL;
	...
	LPWSTR manifest = (LPWSTR)malloc(cbMaxManifestLength);
    if (NULL == manifest)
    {
        _aligned_free(context);
        return E_OUTOFMEMORY;
	...
	size_t cchManifestLength = 0;
    if (FAILED(StringCbPrintfW(manifest, cbMaxManifestLength, CvMarkersManifestTemplate, guidString)) ||
		FAILED(StringCchLengthW(manifest, cbMaxManifestLength / sizeof(WCHAR), &cchManifestLength)))
    {
        free(manifest);
        _aligned_free(context);
        return E_INVALIDARG;
	...
	// Convert manifest to ANSI string and write into context.
	int cbaManifestLength = WideCharToMultiByte(CP_ACP, 0, manifest, gsl::narrow<int>(cchManifestLength) + 1, NULL, 0, NULL, NULL);
	if (cbaManifestLength <= 0)
	{
        free(manifest);
        _aligned_free(context);
        return E_INVALIDARG;
    ...
    context->Manifest = (LPSTR)malloc(cbaManifestLength);
	...
	if (WideCharToMultiByte(CP_ACP, 0, manifest, gsl::narrow<int>(cchManifestLength) + 1, context->Manifest, cbaManifestLength, NULL, NULL) != cbaManifestLength)
	{
        free(manifest);
	...
	context->cbManifestLength = cbaManifestLength - 1;
    free(manifest);
